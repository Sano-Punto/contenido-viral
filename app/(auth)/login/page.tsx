...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // El middleware se encargará de validar el email, pero también podemos validarlo aquí rápido
    // El usuario se redirigirá y el middleware verificará si es el permitido.
    router.push('/');
    router.refresh(); // Para asegurar que el layout lea el estado actualizado
  };
